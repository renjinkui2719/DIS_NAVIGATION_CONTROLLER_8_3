...
@property(readonly, nonatomic) NSObject *currentBackButton;
...
@property(retain, nonatomic) NSObject *refreshControlHost;
...
- (id)hitTest:(struct CGPoint)arg1 forEvent:( void *)arg2;
...
- (void *)_heightRangeForNavigationItem:(id)arg1 fittingWidth:(double)arg2;
...
- (id)navigationItems;
@property(readonly, nonatomic) NSObject *_stack;
...
- (void)_performUpdatesIgnoringLock:(dispatch_block_t)arg1;
